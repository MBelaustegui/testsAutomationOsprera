...
@Feature("Pedidos de Prótesis")
@Story("Flujo Completo de Pedido de Prótesis")
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@ExtendWith(TestFailureListener.class)
public class PedidoProtesisTest {
    
    private static WebDriver driver;
    private static PedidoProtesisPage pedidoProtesisPage;
    ...
    static void setUp() {
        ...
        pedidoProtesisPage = new PedidoProtesisPage(driver);
    ...
    @Test
    @Order(1)
    @Description("Flujo completo de pedido de prótesis: desde la creación hasta el envío a auditoría")
    @Severity(SeverityLevel.CRITICAL)
    @Tag("pedidos")
    @Tag("protesis")
    @Tag("flujoCompleto")
    public void flujoCompletoPedidoProtesis() {
        ...
        try {
            ...
            // Step 3: Crear nuevo pedido de prótesis
            crearNuevoPedidoProtesis();
    ...
    @Step("Crear nuevo pedido de prótesis")
    private void crearNuevoPedidoProtesis() {
        Allure.step("Creando nuevo pedido de prótesis");
        
        // Implementar lógica de creación de pedido
        // pedidoProtesisPage.crearNuevoPedido();
        
        Allure.step("Nuevo pedido de prótesis creado");
    }
    
    @Step("Completar datos del pedido")
    private void completarDatosPedido() {
        Allure.step("Completando datos del pedido de prótesis");
        
        // Implementar lógica de completado de datos
        // pedidoProtesisPage.completarDatos();
